...
- **/setRGB** Установка цвета. Строка вида: "ххх ххх ххх", где ххх - яркость цвета в палитре RGB от 0 до 255. 
...
- **/setIncrement** Установка приращения, скорость анимации. Возможные значения float от 0.0 до 1.0. 
...
```
при активации подсветка будет плавно моргать красным цветом в половину яркости. Подробнее об использовании [[content/Платформа moduleBox/Software#Внутренние связи(cross_link)|crossLink]]
