...
## Совместимость:
- [[content/Аппаратные модули/button_smartLed_hw|button_smartLed_hw]]
...
- **increment** - *число*(float), приращение за один период анимации, скорость анимации.
...
- Меняет состояние светодиода, возможные значения 0-1. Пример:
	"*moduleBox/smartLed_3:1*"
- **/setRGB** Установка цвета. Строка вида: "ххх ххх ххх", где ххх - яркость цвета в палитре RGB от 0 до 255. Пример:
	"*moduleBox/smartLed_3/setRGB:255 0 0*"
- **/setMode** Установка режима свечения. Возможные значения см. п. [[#Режимы анимации]]. Пример:
	"*moduleBox/smartLed_3/setMode:flash*"
- **/setIncrement** Установка приращения, скорость анимации. Возможные значения float от 0.0 до 1.0. Пример:
	"*moduleBox/smartLed_3/setIncrement:0.05*"
...
```
при активации подсветка будет плавно моргать красным цветом в половину яркости. Подробнее об использовании [[cross_link]]:
