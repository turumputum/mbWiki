...
- **waitingTime** - *число(int)*, время ожидания набора следующей цифры. Единица измерения $мсек$. По умолчанию 3 $Сек$.
...
```
В случае большого количества связей можно использовать модуль [[content/Программные модули/whitelist_sw|whitelist_sw]]
```ini
