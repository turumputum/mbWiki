...
[[Программные модули/startup_sw|Режим startup]]
...
Для первоначальной инициализации используется виртуальный слот [[content/Программные модули/startup_sw|startup]].
