...
## Описание
Устройство предназначено для реализации поворотного интерфейса для интерактивных цифровых систем. Может быть дополнено кнопкой и подсветкой. Количество фиксированных положений и рабочий диапазон может быть настроен диском трещотки.
...
- (SLOT_0) - [[Программные модули/encoderPPM_sw|Энкодер PPM]]
