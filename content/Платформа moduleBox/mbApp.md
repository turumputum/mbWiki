...
- автодополнение доступных команд и параметров [[Платформа moduleBox/CrossLink|crossLink]].

## Cross-link Builder

Встроенный пошаговый мастер построения [[Платформа moduleBox/CrossLink|crossLink]] правил. Позволяет визуально выбрать:
