...
---
r## Общий состав
![[Платформа-moduleBox/_assets/200-001.jpg]]
...
Для установки внешних источников питания рекомендуется использовать [[Платформа-moduleBox/Аccessory|Монтажная плита]]
...
## Чертежи
- [[Платформа moduleBox/_assets/mb_noBody.pdf|mb_noBody]]
- [[Платформа moduleBox/_assets/200-001.pdf|mb_body]]
- [[Платформа moduleBox/_assets/201-008.pdf|mb mountPlate]]