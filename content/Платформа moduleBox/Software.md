...
```
совместно с символом '@', могут быть использованы условны операторы равно, больше или меньше, если в значение действия установлен спец символ '@', в действие будет передан результат сравнения, иначе значение действия если выполнится условие:
- == - равно, например:
 ```ini
