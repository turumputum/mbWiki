...
> Описание модуля **hlk2410** для прошивок до перехода на
> [[Платформа moduleBox/Конституция|конституцию]] (топик `radar_<slot>`,
> рапорт без `event`/`action`, опция `topic`). Актуальное описание —
