...
> Описание модуля **collector** для прошивок до перехода на
> [[Платформа moduleBox/Конституция|конституцию]] (топики без `event`/`action`).
> Актуальное описание — [[Программные модули/Виртуальные модули/collector_sw|collector]].
