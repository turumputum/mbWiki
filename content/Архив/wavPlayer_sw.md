...
> Описание модуля **wavPlayer** для прошивок до перехода на
> [[Платформа moduleBox/Конституция|конституцию]] (опция `topic`, команды без `event`/`action`).
> Актуальное описание — [[Программные модули/Звуковые модули/wavPlayer_sw|wavPlayer]].
