...
> Описание модуля **encoderAS5600** для прошивок до перехода на
> [[Платформа moduleBox/Конституция|конституцию]] (рапорт `encoder_<slot>:значение`
> без `event`/`action`). Актуальное описание —
...
## Совместимость:
- [[Аппаратные модули/i2c_hw|i2c модуль]]
## Принцип работы
