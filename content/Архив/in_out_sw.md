...
> Описание модуля **in_out** для прошивок до перехода на
> [[Платформа moduleBox/Конституция|конституцию]] (опции `inTopic`/`outTopic`, рапорт и команды без `event`/`action`).
> Актуальное описание — [[Программные модули/Входы и выходы/in_out_sw|in_out]].
