...
> Описание модуля **button_swiperLed** для прошивок до перехода на
> [[Платформа moduleBox/Конституция|конституцию]] (топик действия `swiperLed_<slot>`, рапорт без `event`/`action`).
> Актуальное описание — [[Программные модули/Кнопки с подсветкой/button_swiperLed_sw|button_swiperLed]].
