...
> Описание модуля **whitelist** для прошивок до перехода на
> [[Платформа moduleBox/Конституция|конституцию]] (топики без `event`/`action`).
> Актуальное описание — [[Программные модули/Виртуальные модули/whitelist_sw|whitelist]].
