---
title: Аудиоэтикетка+ (архив)
draft: false
tags:
  - device
  - archive
---
> [!warning] Архивная версия
> Описание устройства для прошивок до перехода на
> [[Платформа moduleBox/Конституция|конституцию]] (crosslink без `event`/`action`).
> Актуальное описание — [[Устройства/AudiostickPlus|Аудиоэтикетка+]].
...
[[Программные модули/Кнопки с подсветкой/button_led_sw|Режим кнопка с управляемой подсветкой]]
- [SLOT_3] - [[Аппаратные модули/button_led_hw|Модуль кнопка с подсветкой]]
[[Программные модули/Кнопки с подсветкой/button_led_sw|Режим кнопка с подсветкой]]
...
[[Программные модули/Кнопки с подсветкой/button_led_sw|Режим кнопка с подсветкой]]
[SLOT_6] - [[Программные модули/Виртуальные модули/index|Виртуальный слот]]
[[Программные модули/Виртуальные модули/startup_sw|Режим startup]]
...
mode = startup 
options = empty 
crosslink = startup_6/started->led_3:1, startup_6/started->player_0/shift:0 
```
