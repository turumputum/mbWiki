...
> [[Платформа moduleBox/Конституция|конституцию]] (crosslink и файл whitelist без
> `event`/`action`). Актуальное описание — [[Устройства/retroTelephone|Ретро телефон]].
...
- (SLOT_1) - [[Аппаратные модули/SD_card_hw|SD_card]]
...
- (SLOT_0) - [[Программные модули/Звуковые модули/mp3Player_sw|Аудио проигрыватель]]
- (SLOT_1) - [[Платформа moduleBox/Software|SDcard]]
- (SLOT_2) - [[Программные модули/Кнопки с подсветкой/button_led_sw|Модуль кнопка с подсветкой]]
