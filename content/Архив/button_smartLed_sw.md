...
> Описание модуля **button_smartLed** для прошивок до перехода на
> [[Платформа moduleBox/Конституция|конституцию]] (топик действия `smartLed_<slot>`, рапорт без `event`/`action`).
> Актуальное описание — [[Программные модули/Кнопки с подсветкой/button_smartLed_sw|button_smartLed]].
