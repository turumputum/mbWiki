...
> Описание модуля **in_2ch** для прошивок до перехода на
> [[Платформа moduleBox/Конституция|конституцию]] (опция `topic`, рапорт без `event`/`action`).
> Актуальное описание — [[Программные модули/Входы и выходы/in_2ch_sw|in_2ch]].
